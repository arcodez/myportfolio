...
const about = {
  firstName: 'Abel',
  lastName: 'Rodriguez',
  shortDesc: `I'm a web developer located in Venezuela.`,
  longDesc: [
...
const gallery = [
  {
    name: 'Delicias Vallemar',
    image: 'https://radioinfinitagoya.com.ar/v1/wp-content/uploads/2020/06/compras-por-coronavirus.jpg',
    desc: 'Tienda Familiar de Productos para el Hogar',
  },  {
    name: 'Bordados Margarita',
    desc: 'Prendas Para Bordar Como Uniformes, Marcas Personales y Demás',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQT2if85S_TEMGJxzFMF6Fmx82QD7mv9e4Lyg&usqp=CAUhttps://picsum.photos/400/410',
  },  {
    name: 'Anime Shop',
    desc: 'Futura Web De Productos De Anime',
    image: 'https://i0.wp.com/jellygoods.com/wp-content/uploads/2018/12/Levi-detergente-japon-attack-on-titan.jpg?ssl=1&resize=1511%2C1511https://picsum.photos/400/410',
  },  {
    name: '',
    image: '',
    desc: '',
...
export default {
  colors, about, projects, skills, gallery
}

export { colors, about, projects, skills, gallery };
